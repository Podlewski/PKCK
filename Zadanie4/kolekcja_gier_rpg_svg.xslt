...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	<xsl:template match="Zestawienie_gier_rpg">
		...
		<rect x="805" y="025" height="40" width="30" fill="#ffffb2" stroke="black" stroke-width="2" onclick="playRilakkuma(evt)"/>
		<text x="855" y="055" font-family="georgia" fill="#ffffff" font-size="40" allign ="center">
			&lt;- kliknij mnie!
		</text>
    	...
    	<xsl:for-each select="Posortowane_systemy_według_popularności/System_gry">
			...
			<rect x="{$pos + 115}" y="170" height="30" width="0" fill="#282828" stroke="black" stroke-width="2">
				<animate attributeType="XML" attributeName="width" from="0" to="{200}" dur="1s" fill="freeze"/>
			</rect>
			<rect x="{$pos + 115}" y="170" height="30" width="0" fill="#B8B8B8" stroke="black" stroke-width="2">
				<animate attributeType="XML" attributeName="width" from="0" to="{$ocena*2}"	dur="3s" fill="freeze"/>
			</rect>
